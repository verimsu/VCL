...
from proj_head import VCLProjectionHead
from vcl_obj import VCLObjective
...
class VCL(LightningModule):
    ...
    def training_step(
        ...
        loss = self.criterion(z0, z1) + self.vcl_obj(mu0, mu1, logVar0, logVar1)
        self.log(
